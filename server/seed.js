  ...
  await Test.create([
    {
      ...
      questions: [
        { title: "Mr Griffin has been to the Sunrise Hotel ...", options: ["... once previously.", "... twice previously.", "... three times previously."], answer: "... twice previously.", marks: 1 },
        { title: "Mr Griffin is from ...", options: ["... Melbourne.", "... Sydney.", "... Perth."], answer: "... Melbourne.", marks: 1 },
        { title: "Mr Griffin's passport number is ...", options: ["... 87647489.", "... 87637289.", "... 87637489."], answer: "... 87637489.", marks: 1 },
        { title: "Mr Griffin wants to book ...", options: ["... a single room for 2 nights.", "... a double room for 2 nights.", "... a single room for 1 night."], answer: "... a single room for 2 nights.", marks: 1 },
        { title: "Mr Griffin will arrive at the Sunrise Hotel at ...", options: ["... 9.15 p.m.", "... 10.00 p.m.", "... 9.35 p.m."], answer: "... 9.35 p.m.", marks: 1 },
        { title: "What number room will Mr Griffin be in?", options: [], answer: "Room 305", marks: 1 },
      ],
    },
    {
      examId: exam._id,
...
<p>While the Port of London already collects up to 3,000 tons of solid waste from the tideway every year, Thames Water now plans to introduce a new device to capture more rubbish floating down the river.</p>`,
      ...
      questions: [
        { title: "Operating the rubbish muncher", options: ["The Environment Agency", "Transport for London", "The Greater London Council", "Thames Water", "Port of London", "Local boroughs"], answer: "Thames Water", marks: 1 },
        { title: "Creating community strategies", options: ["The Environment Agency", "Transport for London", "The Greater London Council", "Thames Water", "Port of London", "Local boroughs"], answer: "Local boroughs", marks: 1 },
        { title: "Monitoring the cleanliness of the river", options: ["The Environment Agency", "Transport for London", "The Greater London Council", "Thames Water", "Port of London", "Local boroughs"], answer: "The Environment Agency", marks: 1 },
        { title: "Collecting solid waste from the tideway", options: ["The Environment Agency", "Transport for London", "The Greater London Council", "Thames Water", "Port of London", "Local boroughs"], answer: "Port of London", marks: 1 },
        { title: "Creating enlarged sewage works", options: ["The Environment Agency", "Transport for London", "The Greater London Council", "Thames Water", "Port of London", "Local boroughs"], answer: "The Greater London Council", marks: 1 },
        { title: "Controlling traffic on the river", options: ["The Environment Agency", "Transport for London", "The Greater London Council", "Thames Water", "Port of London", "Local boroughs"], answer: "Transport for London", marks: 1 },
        { title: "The River Thames is now the cleanest metropolitan river in the world.", options: ["True", "False", "Not Given"], answer: "True", marks: 1 },
        { title: "All fish species have returned to the River Thames.", options: ["True", "False", "Not Given"], answer: "False", marks: 1 },
      ],
    },
  ]);
